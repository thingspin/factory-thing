...
- file exist path : open62541_mqtt/mqtt/CMakeLists.txt 
    ...
    - EX) line 1: set(EXTER_MQTT_ROOT "/home/mint/paho.mqtt.embedded-c" CACHE STRING "MQTT paho header and library root path")
    - EX) line 2: set(EXTER_JSON_ROOT "/home/mint/json-c" CACHE STRING "JSON header and library root path")
